...
<html lang="en">
    ...
    <body>
        ...
        <div class="row g-4 mt-3">
                <div class="col-5 bg-light mx-auto">
                    ...
                    <form method="POST">
                        <div class="mb-3">
                            ...
                            <input type="file" name="imgProdutor" class="form-control">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="emailProdutor" class="form-control">
                        </div>
                        <div class="mb-3">
                            <label>Descriçõ</label>
                            <input type="text" name="descProdutor" class="form-control">
                        </div>
                        <div class="mb-3">
                            <button type="submit" class="btn border border-secondary rounded-pill px-3 text-primary">EDITAR</button>
                        </div>
                    </form>
                </div>
            </div>
