...
<html lang="en">
    ...
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="img/IconCampoConecta.jpeg">
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Contate-nos</h1>
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item"><a href="#">Pages</a></li>
                <li class="breadcrumb-item active text-white">Contate-nos</li>
            </ol>
        </div>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="text-center mx-auto" style="max-width: 700px;">
                                <h1 class="text-primary">Entre em contato via formulario</h1>
                                <p class="mb-4"></a></p>
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <form action="" class="">
                                <input type="text" class="w-100 form-control border-0 py-3 mb-4" placeholder="Nome">
                                <input type="email" class="w-100 form-control border-0 py-3 mb-4" placeholder="Email">
                                <textarea class="w-100 form-control border-0 mb-4" rows="5" cols="10" placeholder="Mensagem"></textarea>
                        ...
                        <div class="col-lg-5">
                            <div class="d-flex p-4 rounded mb-4 bg-white">
                                ...
                                <div>
                                    <h4>Nosso Email</h4>
                                    <p class="mb-2">campoconecta@gmail.com</p>
                                </div>
                            </div>
